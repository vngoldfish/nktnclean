  ...
  return (
    <main className="site-shell">
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:py-28">
        <Badge variant="blue" className="mb-6">{content.dxPage.badge}</Badge>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-24 sm:px-8">
        ...
        <div className="mt-8 rounded-[2.5rem] bg-nktn-ink p-8 text-white lg:p-12">
          <p className="text-sm font-black tracking-[0.2em] text-nktn-orange">SMART FIELD MANAGEMENT</p>
        ...
        <Button className="mt-10" asChild>
          <Link href={companyBase.lineUrl}>
            {content.dxPage.cta} <ArrowRight className="size-4" />
          </Link>
        </Button>
      </section>
    </main>
