  ...
  return (
    <main className="site-shell">
      <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:py-28">
        <p className="text-sky-800 text-sm font-black tracking-widest mb-3">{content.dxPage.badge}</p>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-24 sm:px-8">
        <div className="grid gap-5 lg:grid-cols-4">
          {content.dxItems.map(([title, body], index) => {
            ...
            return (
              <Card key={title} className="p-7 border border-slate-100 hover:border-sky-100 transition duration-300 hover:shadow-soft hover:-translate-y-0.5">
