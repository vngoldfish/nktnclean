  ...
  return (
    <section className="bg-gradient-to-b from-sky-900 via-sky-800 to-sky-900 py-12 px-5 sm:px-8">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <h2 className="text-white text-2xl sm:text-3xl lg:text-4xl font-black mb-8">
        ...
        >
          ...
          <div className="text-left">
            ...
            <span className="block text-white text-3xl sm:text-4xl lg:text-5xl font-black tracking-wider">
              {companyBase.phone}
            </span>
          </div>
        </Link>
