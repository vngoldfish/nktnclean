  ...
  return (
    <section className="py-20 px-5 sm:px-8 bg-[#F6F6F6] border-b border-slate-200/80">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid sm:grid-cols-2 gap-4 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 mb-12 shadow-xs">
          {points.map((item, idx) => (
            <div key={idx} className="flex items-center gap-3.5 p-2">
              <span className="grid size-7 shrink-0 place-items-center rounded-full bg-[#19BAD7] text-white shadow-xs">
        ...
        {/* 2 Clean Split Career / Partner Cards (Super Hotel Clean .project_list style) */}
        <div className="grid sm:grid-cols-2 gap-6">
          {/* Card 1 */}
          <Link
            href={withLocale(locale, "/contact")}
            className="group rounded-2xl bg-white border border-slate-200/80 p-6 hover:border-[#00729F] hover:shadow-md transition-all duration-300 flex flex-col justify-between"
          >
            <div>
              <span className="text-[11px] font-black text-[#00729F] bg-sky-50 border border-sky-100 px-2.5 py-0.5 rounded uppercase">
                Recruit
              </span>
          ...
          >
            <div>
              <span className="text-[11px] font-black text-amber-700 bg-amber-50 border border-amber-100 px-2.5 py-0.5 rounded uppercase">
                Partner / Part-time
              </span>
              <h3 className="font-serif-jp text-lg sm:text-xl font-black text-slate-900 mt-3 group-hover:text-[#00729F] transition-colors">
